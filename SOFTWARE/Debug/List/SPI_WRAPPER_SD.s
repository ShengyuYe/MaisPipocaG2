///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.50.3.4676/W32 for ARM     06/Jul/2017  16:40:31 /
// Copyright 1999-2013 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\Users\Marcos\Dropbox\Reps\Dextro\IBA\Hardware\MaisPi /
//                    pocaG2\SOFTWARE\Drivers\SD CARD\SPI_WRAPPER_SD.C        /
//    Command line =  "C:\Users\Marcos\Dropbox\Reps\Dextro\IBA\Hardware\MaisP /
//                    ipocaG2\SOFTWARE\Drivers\SD CARD\SPI_WRAPPER_SD.C" -lC  /
...
// C:\Users\Marcos\Dropbox\Reps\Dextro\IBA\Hardware\MaisPipocaG2\SOFTWARE\Drivers\SD CARD\SPI_WRAPPER_SD.C
...
//   36 *   Definições
//   37 ***********************************************************************************/
//   38 #define SSP_SR_TFE            ((unsigned int)(1<<0)) /** SSP status TX FIFO Empty bit */
//   39 #define SSP_SR_TNF            ((unsigned int)(1<<1)) /** SSP status TX FIFO not full bit */
//   40 #define SSP_SR_RNE            ((unsigned int)(1<<2)) /** SSP status RX FIFO not empty bit */
//   41 #define SSP_SR_RFF            ((unsigned int)(1<<3)) /** SSP status RX FIFO full bit */
//   42 #define SSP_SR_BSY            ((unsigned int)(1<<4)) /** SSP status SSP Busy bit */
//   43 #define SSP_SR_BITMASK	      ((unsigned int)(0x1F)) /** SSP SR bit mask */
//   44 
