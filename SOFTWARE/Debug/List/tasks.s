///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.50.3.4676/W32 for ARM     21/Jun/2017  11:11:54 /
// Copyright 1999-2013 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  C:\Users\Marcos\Dropbox\Cli\AlmTec\01-Firmware\01_mais_ /
//                    pipoca_exp\MaisPipoca - 2.0.11\Kernel\tasks.c           /
//    Command line =  "C:\Users\Marcos\Dropbox\Cli\AlmTec\01-Firmware\01_mais /
//                    _pipoca_exp\MaisPipoca - 2.0.11\Kernel\tasks.c" -lC     /
...
//                    pipoca_exp\MaisPipoca - 2.0.11\Debug\List\tasks.s       /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\Marcos\Dropbox\Cli\AlmTec\01-Firmware\01_mais_pipoca_exp\MaisPipoca - 2.0.11\Kernel\tasks.c
...
??vTaskIncrementTick_2:
        ...
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BEQ.N    ??vTaskIncrementTick_6
        LDR.W    R0,??DataTable29_11
        LDR      R0,[R0, #+0]
        LDR      R0,[R0, #+12]
        LDR      R4,[R0, #+12]
        B.N      ??vTaskIncrementTick_7
??vTaskIncrementTick_6:
        MOVS     R4,#+0
??vTaskIncrementTick_7:
        CMP      R4,#+0
        BEQ.N    ??vTaskIncrementTick_8
        LDR.W    R0,??DataTable29_9
        LDR      R0,[R0, #+0]
        LDR      R1,[R4, #+4]
        CMP      R0,R1
        BCS.N    ??vTaskIncrementTick_3
        B.N      ??vTaskIncrementTick_8
//  831     }
//  832     else
//  833     {
//  834 	 ++uxMissedTicks;
...
??usTaskCheckFreeStackSpace_0:
        LDRB     R2,[R0, #+0]
        CMP      R2,#+165
        BEQ.N    ??usTaskCheckFreeStackSpace_1
// 1173 
...
// 
// 2 916 bytes of CODE  memory (+ 20 bytes shared)
