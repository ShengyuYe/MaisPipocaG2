///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.50.3.4676/W32 for ARM     19/Jul/2017  14:20:59 /
...
//  149              
//  150            APLICACAO_release_lcd();  
//  151            
//  152            STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);
//  153            break;
//  154       case TECLA_ESC:
//  155            break;
//  156       case TECLA_GRATIS:
//  157            if(modo_gratis)
//  158              PAGAMENTOS_adiciona_valores(valorPipoca);
//  159            break;      
//  160     }
//  161     
//  162     if(modo_gratis)
//  163       STRING_write_to_external(NO_CLEAR,(void*)STRING_mensagem_modo_gratis[idioma][0],(void*)STRING_mensagem_modo_gratis[idioma][1]);
//  164     else{
//  165       APLICACAO_exibe_valor(idioma);     
??APLICACAO_main_1:
        MOVS     R0,R4
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  167         APLICACAO_verifica_disponibilidade_troco(idioma);
        MOVS     R0,R4
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
          CFI FunCall APLICACAO_verifica_disponibilidade_troco
        BL       APLICACAO_verifica_disponibilidade_troco
//  168       // Verifica a conectividade dos
//  169       // meios de pagamento seriais
//  170       APLICACAO_verifica_MDB();
??APLICACAO_main_2:
          CFI FunCall APLICACAO_verifica_MDB
        BL       APLICACAO_verifica_MDB
//  171       APLICACAO_verifica_cctalk();
          CFI FunCall APLICACAO_verifica_cctalk
        BL       APLICACAO_verifica_cctalk
//  172     }
//  173     
//  174     APLICACAO_verifica_preparacao(valorPipoca,idioma,modo_troco);             
??APLICACAO_main_3:
        LDRB     R2,[SP, #+0]
        MOVS     R1,R4
...
//  175     BOARD_setter_led_instrucao(LED_INSIRA_DINHEIRO,PISCANDO); // Ativa o modo inserir dinheiro
        MOVS     R1,#+2
        MOVS     R0,#+2
          CFI FunCall BOARD_setter_led_instrucao
        BL       BOARD_setter_led_instrucao
//  176     APLICACAO_tela_descanso();    
          CFI FunCall APLICACAO_tela_descanso
        BL       APLICACAO_tela_descanso
//  177 #ifndef _DEBUG_PAGAMENTOS_    
//  178     APLICACAO_verificao_ciclica();
...
//  180     vTaskDelay(50);
        MOVS     R0,#+50
          CFI FunCall vTaskDelay
        BL       vTaskDelay
//  181     APLICACAO_ciclo_desumidificador(flag_desumidificador);
        LDRB     R0,[SP, #+2]
...
//  183 }
//  184 /***********************************************************************************
//  185 *       Descrição       :       Inicialização do ódulo
...
//  188 ***********************************************************************************/
        ...
        THUMB
//  189 void APLICACAO_ini(void){
APLICACAO_ini:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  190   eIDIOMA idioma  = BRASIL;
        MOVS     R4,#+0
//  191        
//  192   HD44780_init(LCD_DISPLAY_8X5 | LCD_2_LINHAS,
//  193                LCD_DISPLAY_LIGADO | LCD_CURSOR_DESLIGADO | LCD_CURSOR_FIXO);     
        MOVS     R1,#+4
        MOVS     R0,#+8
          CFI FunCall HD44780_init
        BL       HD44780_init
//  194   
//  195   HD44780_2_init(LCD_DISPLAY_8X5 | LCD_2_LINHAS,
//  196                  LCD_DISPLAY_LIGADO | LCD_CURSOR_DESLIGADO | LCD_CURSOR_FIXO);       
        ...
        BL       HD44780_2_init
//  197   
//  198   STRING_write_to_internal(CLEAR_DISPLAY,
//  199                            (char*)STRING_splash[idioma][0],
//  200                            (char*)STRING_splash[idioma][1]);      
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ...
        BL       STRING_write_to_internal
//  201   
//  202   STRING_write_to_external(CLEAR_DISPLAY,
//  203                            (char*)STRING_mensagem_saudacao_maquina[idioma][0],
//  204                            (char*)STRING_mensagem_saudacao_maquina[idioma][1]);      
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ...
        BL       STRING_write_to_external
//  205   
//  206   vSemaphoreCreateBinary(APLICACAO_sem_LCD);
        MOVS     R1,#+0
        MOVS     R0,#+1
...
//  208 /***********************************************************************************
//  209 *       Descrição       :       Semáforo para acessar o LCD
//  210 *       Parametros      :       nenhum
//  211 *       Retorno         :       nenhum
//  212 ***********************************************************************************/
        ...
        THUMB
//  213 void APLIACAO_wait_lcd(void){
APLIACAO_wait_lcd:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  214   
//  215   while(!xSemaphoreTake(APLICACAO_sem_LCD,portTICK_RATE_MS*1));
??APLIACAO_wait_lcd_0:
        MOVS     R3,#+0
        MOVS     R2,#+1
        MOVS     R1,#+0
...
//  217 /***********************************************************************************
//  218 *       Descrição       :       Libera o semáforo do LCD
...
//  221 ***********************************************************************************/
        ...
        THUMB
//  222 void APLICACAO_release_lcd(void){
APLICACAO_release_lcd:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  223   
//  224   xSemaphoreGive(APLICACAO_sem_LCD);
        MOVS     R3,#+0
        MOVS     R2,#+0
        MOVS     R1,#+0
        LDR.W    R0,??DataTable14_3
...
//  226 /***********************************************************************************
//  227 *       Descrição       :       Funções para carregar o idioma
...
//  230 ***********************************************************************************/
        ...
        THUMB
//  231 unsigned char APLICACAO_carrega_idioma(void){
APLICACAO_carrega_idioma:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  232   unsigned char idioma  = BRASIL;
        MOVS     R0,#+0
        STRB     R0,[SP, #+0]
//  233   
//  234   PARAMETROS_le(ADR_FLAG_IDIOMA,(void*)&idioma);  
        ADD      R1,SP,#+0
        MOVS     R0,#+0
          CFI FunCall PARAMETROS_le
        BL       PARAMETROS_le
//  235   if(idioma>QTY_OF_LANGUAGES)
        LDRB     R0,[SP, #+0]
        CMP      R0,#+8
...
//  239 }
//  240 /***********************************************************************************
//  241 *       Descrição       :       Tela de descanso do display interno
...
//  244 ***********************************************************************************/
        ...
        THUMB
//  245 void APLICACAO_tela_descanso(void){
APLICACAO_tela_descanso:
        ...
        SUB      SP,SP,#+24
          CFI CFA R13+40
//  246   char buffer_linha[17];
//  247   
//  248   sprintf(buffer_linha,"RPM:%05d T%03doC",POTENCIA_getRPMmedido(),AA_calculaTemperatura());
        ...
        ADD      R0,SP,#+4
          CFI FunCall sprintf
        BL       sprintf
//  249   STRING_write_to_internal(NO_CLEAR,buffer_linha,NULL);    
        MOVS     R2,#+0
        ADD      R1,SP,#+4
        MOVS     R0,#+1
          CFI FunCall STRING_write_to_internal
        BL       STRING_write_to_internal
//  250   
//  251   sprintf(buffer_linha,"P:%04d M:%04d,%02d",AA_mediaMovelPapel(),
//  252                                             PAGAMENTOS_get_valor_acumulado()/100,
//  253                                             PAGAMENTOS_get_valor_acumulado()%100);
          CFI FunCall PAGAMENTOS_get_valor_acumulado
        BL       PAGAMENTOS_get_valor_acumulado
        MOVS     R4,R0
        MOVS     R5,#+100
        ...
        BL       sprintf
//  254   
//  255   STRING_write_to_internal(NO_CLEAR,NULL,buffer_linha);
        ADD      R2,SP,#+4
        MOVS     R1,#+0
        MOVS     R0,#+1
          CFI FunCall STRING_write_to_internal
...
//  257 /***********************************************************************************
//  258 *       Descrição       :       Exibe o valor da pipoca e 
//  259 *                               o quanto já foi pago pelo cliente
...
//  262 ***********************************************************************************/
        ...
        THUMB
//  263 void APLICACAO_exibe_valor(unsigned char idioma){
APLICACAO_exibe_valor:
        ...
        SUB      SP,SP,#+24
          CFI CFA R13+32
        MOVS     R4,R0
//  264   unsigned int valor;
//  265   char buffer_linha[17];
//  266   static unsigned char indice=0;
//  267   
//  268   PARAMETROS_le(ADR_VALOR_PIPOCA,(void*)&valor);
        ADD      R1,SP,#+0
        MOVS     R0,#+3
          CFI FunCall PARAMETROS_le
        BL       PARAMETROS_le
//  269   sprintf(buffer_linha,STRING_mensagem_preco[idioma],valor/100,valor%100);
        LDR      R0,[SP, #+0]
        MOVS     R1,#+100
        UDIV     R2,R0,R1
        MLS      R3,R1,R2,R0
        ...
        ADD      R0,SP,#+4
          CFI FunCall sprintf
        BL       sprintf
//  270   STRING_write_to_external(NO_CLEAR,buffer_linha,NULL);    
        MOVS     R2,#+0
        ADD      R1,SP,#+4
        MOVS     R0,#+1
          CFI FunCall STRING_write_to_external
        BL       STRING_write_to_external
//  271   
//  272   unsigned int pago = PAGAMENTOS_get_valor_acumulado();
          CFI FunCall PAGAMENTOS_get_valor_acumulado
        BL       PAGAMENTOS_get_valor_acumulado
//  273   
//  274   if(pago){    
...
//  275     sprintf(buffer_linha,STRING_mensagem_pago[idioma],pago/100,pago%100);
        MOVS     R1,#+100
        UDIV     R2,R0,R1
        MLS      R3,R1,R2,R0
        MOVS     R1,#+100
        ...
        ADD      R0,SP,#+4
          CFI FunCall sprintf
        BL       sprintf
//  276     STRING_write_to_external(NO_CLEAR,NULL,buffer_linha);
        ADD      R2,SP,#+4
        MOVS     R1,#+0
        MOVS     R0,#+1
          CFI FunCall STRING_write_to_external
...
//  280       indice = (indice+1) % 4;
        ...
        LDR.W    R0,??DataTable14_9
        STRB     R2,[R0, #+0]
//  281       APLICACAO_tempo_mensagem = TEMPO_MENSAGEM_LINHA_INFERIOR;
        LDR.W    R0,??DataTable14_8
        MOVW     R1,#+10000
        STR      R1,[R0, #+0]
//  282     }
//  283     PARAMETROS_le(ADR_MENSAGEM_CLIENTE_01+indice,(void*)buffer_linha);
...
??indice:
        DS8 1
//  287 /***********************************************************************************
//  288 *       Descrição       :       Verifica a contagem dos tubos de moeda
//  289 *       Parametros      :       nenhum
//  290 *       Retorno         :       (unsigned char) maior do que zero se há troco
//  291 ***********************************************************************************/
...
//  299 }
//  300 /***********************************************************************************
//  301 *       Descrição       :       Faz a verificação dos pagamentos para
//  302 *                               iniciar o ciclo de preparação
//  303 *       Parametros      :       (unsigned int) valor da pipoca
//  304 *       Retorno         :       nenhum
//  305 ***********************************************************************************/
        ...
        THUMB
//  306 void APLICACAO_verifica_preparacao(unsigned int valor_pipoca,unsigned char idioma,
//  307                                    unsigned char troco){
APLICACAO_verifica_preparacao:
        ...
        MOVS     R4,R1
        MOVS     R6,R2
//  308    unsigned int ajuste;
//  309   
//  310   if( PAGAMENTOS_get_valor_acumulado()>=valor_pipoca) {      
          CFI FunCall PAGAMENTOS_get_valor_acumulado
        BL       PAGAMENTOS_get_valor_acumulado
        CMP      R0,R5
        BCC.W    ??APLICACAO_verifica_preparacao_0
//  311     
//  312     if(troco==OPERA_SEM_TROCO || APLICACACAO_verifica_troco()>=valor_pipoca){     
...
//  313       // Switch para 
//  314       // capturar os resultados da execução do processo
//  315       switch(PREPARACAO_entry(&ajuste,CONTABILIZA)){
...
//  316         case SUCESSO:
//  317              PAGAMENTOS_subtrai_valores(valor_pipoca);          
??APLICACAO_verifica_preparacao_3:
        MOVS     R0,R5
          CFI FunCall PAGAMENTOS_subtrai_valores
        BL       PAGAMENTOS_subtrai_valores
//  318              // Devolve o troco caso ainda reste valor
//  319              // pago no acumulador de moeda
//  320              if(troco==OPERA_COM_TROCO && PAGAMENTOS_get_valor_acumulado()){               
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+255
...
//  321                STRING_write_to_external(CLEAR_DISPLAY,
//  322                                         (char*)STRING_mensagem_retire_troco[idioma][0],
//  323                                         (char*)STRING_mensagem_retire_troco[idioma][1]);
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ...
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_external
        BL       STRING_write_to_external
//  324                APLICACAO_devolve_troco();      
          CFI FunCall APLICACAO_devolve_troco
        BL       APLICACAO_devolve_troco
//  325              }
//  326              PREPARACAO_resfriamento(idioma);
??APLICACAO_verifica_preparacao_8:
        MOVS     R0,R4
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
          CFI FunCall PREPARACAO_resfriamento
        BL       PREPARACAO_resfriamento
//  327              STRING_write_to_external(CLEAR_DISPLAY,NULL,NULL);                
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_external
        BL       STRING_write_to_external
//  328              PAGAMENTOS_set_bloqueio(0);
        MOVS     R0,#+0
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  329              break;
        B.N      ??APLICACAO_verifica_preparacao_2
//  330         case FALHA_VENTILADOR:
//  331              STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E0:VENTILADOR");                       
...
//  334              break;
        B.N      ??APLICACAO_verifica_preparacao_2
//  335         case FALHA_RESISTENCIA:
//  336              STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E1:AQUECIMENTO");
??APLICACAO_verifica_preparacao_4:
        ...
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_external
        BL       STRING_write_to_external
//  337              APLICACAO_menu_falha();
          CFI FunCall APLICACAO_menu_falha
        BL       APLICACAO_menu_falha
//  338              PAGAMENTOS_set_bloqueio(0);             
        MOVS     R0,#+0
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  339              break;
        B.N      ??APLICACAO_verifica_preparacao_2
//  340         case FALHA_DOSE:
//  341              STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E2:DOSADOR");          
...
//  344              break;
        B.N      ??APLICACAO_verifica_preparacao_2
//  345         case FALHA_EMBALAGEM:
//  346              STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E3:EMBALAGEM");                                                 
...
//  351     }
//  352          
//  353     STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);
??APLICACAO_verifica_preparacao_2:
        ...
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_internal
        BL       STRING_write_to_internal
//  354     BOARD_setter_contador_propaganda(0);
        MOVS     R0,#+0
          CFI FunCall BOARD_setter_contador_propaganda
        BL       BOARD_setter_contador_propaganda
        B.N      ??APLICACAO_verifica_preparacao_9
//  355   }//Fim do inicio do processo de preparação
//  356   else
//  357     if(troco==OPERA_COM_TROCO && !PAGAMENTOS_get_timeout_pagamento() && PAGAMENTOS_get_valor_acumulado()){        
...
//  361 /***********************************************************************************
//  362 *       Descrição       :       Tela quando há alguma falha na máquina
//  363 *       Parametros      :       (unsigned char) idioma
//  364 *       Retorno         :       nenhum
//  365 ***********************************************************************************/
        ...
        THUMB
//  366 void APLICACAO_menu_falha(void){
...
//  367   eTECLA tecla;
//  368                  
//  369   BOARD_setter_led_instrucao(LED_FORA_SERVICO,PISCANDO);
        MOVS     R1,#+2
        MOVS     R0,#+6
          CFI FunCall BOARD_setter_led_instrucao
        BL       BOARD_setter_led_instrucao
//  370   APLICACAO_devolve_troco(); // Devolve o valor ao cliente
          CFI FunCall APLICACAO_devolve_troco
        BL       APLICACAO_devolve_troco
//  371                              // devido a uma falha no sistema
//  372   
//  373   PAGAMENTOS_set_bloqueio(1);
        MOVS     R0,#+1
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
...
//  375   for(;;){
//  376     
//  377     APLICACAO_tela_descanso();           
//  378     
//  379     tecla = TECLADO_getch();
//  380     switch(tecla){
//  381       case TECLA_ENTER:
//  382           APLIACAO_wait_lcd();
??APLICACAO_menu_falha_1:
          CFI FunCall APLIACAO_wait_lcd
        BL       APLIACAO_wait_lcd
//  383           BOARD_liga_placa_instrucao(0);
        MOVS     R0,#+0
          CFI FunCall BOARD_liga_placa_instrucao
        BL       BOARD_liga_placa_instrucao
//  384           MCFG_entry();                     
          CFI FunCall MCFG_entry
        BL       MCFG_entry
//  385           BOARD_liga_placa_instrucao(1);
        MOVS     R0,#+1
          CFI FunCall BOARD_liga_placa_instrucao
        BL       BOARD_liga_placa_instrucao
//  386           APLICACAO_release_lcd();             
          CFI FunCall APLICACAO_release_lcd
        BL       APLICACAO_release_lcd
//  387           STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);                   
        MOVS     R2,#+0
        MOVS     R1,#+0
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_internal
...
//  397 }
//  398 /***********************************************************************************
//  399 *       Descrição       :       Função para devolver o troco ao cliente
//  400 *       Parametros      :       (void)
//  401 *       Retorno         :       (unsigned char) maior do que zero se
//  402 *                               conseguiu devolver o troco
//  403 ***********************************************************************************/
        ...
        THUMB
//  404 unsigned char APLICACAO_devolve_troco(void){
APLICACAO_devolve_troco:
        PUSH     {R0-R6,LR}
          ...
          CFI R4 Frame(CFA, -16)
          CFI CFA R13+32
//  405   unsigned int valor = PAGAMENTOS_get_valor_acumulado();
          CFI FunCall PAGAMENTOS_get_valor_acumulado
        BL       PAGAMENTOS_get_valor_acumulado
        MOVS     R4,R0
//  406   unsigned int desconto = valor;
        MOVS     R5,R4
//  407   unsigned char tubos[16];
//  408   
//  409   PAGAMENTOS_set_bloqueio(0);
        MOVS     R0,#+0
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  410   vTaskDelay(500);
        ...
        BL       vTaskDelay
//  411   
//  412   if(MDB_coin_check_tubes(tubos)){
        ADD      R0,SP,#+0
          CFI FunCall MDB_coin_check_tubes
        BL       MDB_coin_check_tubes
        CMP      R0,#+0
...
//  414     valor /= 25;
        MOVS     R0,#+25
        UDIV     R4,R4,R0
//  415     PAGAMENTOS_subtrai_valores(desconto);
        MOVS     R0,R5
          CFI FunCall PAGAMENTOS_subtrai_valores
        BL       PAGAMENTOS_subtrai_valores
//  416         
//  417     unsigned char moedas_15 = valor /15;
        MOVS     R0,#+15
        UDIV     R5,R4,R0
//  418     unsigned char moedas_rest = valor % 15;
        MOVS     R0,#+15
        UDIV     R1,R4,R0
        MLS      R4,R0,R1,R4
//  419         
//  420     for(unsigned char i=0;i<moedas_15;i++){
        MOVS     R6,#+0
        B.N      ??APLICACAO_devolve_troco_1
//  421       MDB_coin_dispenser(2,15);
...
//  425     if(moedas_rest){
        ...
        CMP      R4,#+0
        BEQ.N    ??APLICACAO_devolve_troco_0
//  426       MDB_coin_dispenser(2,moedas_rest);
        MOVS     R1,R4
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        MOVS     R0,#+2
          CFI FunCall MDB_coin_dispenser
...
//  432 }
//  433 /***********************************************************************************
//  434 *       Descrição       :       Faz a verificação do POST
...
//  437 ***********************************************************************************/
        ...
        THUMB
//  438 unsigned char APLICACAO_verifica_post(void){
APLICACAO_verifica_post:
        PUSH     {R3-R5,LR}
          ...
          CFI R4 Frame(CFA, -12)
          CFI CFA R13+16
//  439   ePOST_RESULT post = POST_entry();
          CFI FunCall POST_entry
        BL       POST_entry
        MOVS     R4,R0
//  440   eIDIOMA idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
          CFI FunCall APLICACAO_carrega_idioma
        BL       APLICACAO_carrega_idioma
        MOVS     R5,R0
//  441   
...
//  443     case POST_SUCESSO:
//  444          return 1;
        MOVS     R0,#+1
        POP      {R1,R4,R5,PC}    ;; return
//  445     case POST_FALHA_VENTILADOR:
//  446     case POST_FALHA_RESISTENCIA:
//  447     case POST_FALHA_MDB_BILL:
//  448     case POST_FALHA_MDB_COIN:
//  449     case POST_FALHA_MDB_CASHLESS:
//  450     case POST_FALHA_CCTALK:
//  451     case POST_FALHA_PAPEL:
//  452     default:
//  453          switch(post){
...
//  454            case POST_FALHA_VENTILADOR:
//  455                 STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E0:MOTOR AR");                                    
...
//  458                 STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E1:AQUECIMENTO");                
...
//  459                 break;
        B.N      ??APLICACAO_verifica_post_2
//  460            case POST_FALHA_MDB_BILL:
//  461                 break;
??APLICACAO_verifica_post_3:
        B.N      ??APLICACAO_verifica_post_2
//  462            case POST_FALHA_MDB_COIN:
//  463                 break;
??APLICACAO_verifica_post_6:
        B.N      ??APLICACAO_verifica_post_2
//  464            case POST_FALHA_MDB_CASHLESS:
//  465                 break;
??APLICACAO_verifica_post_5:
        B.N      ??APLICACAO_verifica_post_2
//  466            case POST_FALHA_CCTALK:
//  467                 break;
??APLICACAO_verifica_post_8:
        B.N      ??APLICACAO_verifica_post_2
//  468            case POST_FALHA_PAPEL:   
//  469                 STRING_write_to_external(CLEAR_DISPLAY,(char*)STRING_mensagem_fora_servico[idioma],"E3:EMBALAGEM");              
...
//  471          }         
//  472          
//  473          PAGAMENTOS_set_bloqueio(1); // Bloqueia os meios de pagamento
??APLICACAO_verifica_post_2:
        MOVS     R0,#+1
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  474          BOARD_liga_placa_instrucao(LED_FORA_SERVICO);
        MOVS     R0,#+6
          CFI FunCall BOARD_liga_placa_instrucao
        BL       BOARD_liga_placa_instrucao
...
//  477            eTECLA tecla;
//  478            
//  479            tecla = TECLADO_getch();
//  480            
//  481            switch(tecla){
//  482              case TECLA_ENTER:
//  483                   APLIACAO_wait_lcd();
//  484                   BOARD_liga_placa_instrucao(0);
//  485                   MCFG_entry();                     
//  486                   BOARD_liga_placa_instrucao(1);
//  487                   idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
//  488                   APLICACAO_release_lcd();  
//  489            
//  490                   STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);               
//  491                   break;
//  492              case TECLA_ESC:
//  493                   break;
//  494              case TECLA_INC:
...
//  503 }
//  504 /***********************************************************************************
//  505 *       Descrição       :       Faz a verificação de troco para o primeiro
//  506 *                               processo
//  507 *       Parametros      :       nenhum
//  508 *       Retorno         :       (unsigned char) maior do que zero
//  509 *                               se houver troco suficiente
//  510 ***********************************************************************************/
        ...
        THUMB
//  511 void APLICACAO_verifica_disponibilidade_troco(unsigned char idioma){
APLICACAO_verifica_disponibilidade_troco:
        PUSH     {R3-R5,LR}
          ...
          CFI CFA R13+16
        MOVS     R4,R0
//  512   unsigned char flag_notas;
//  513   unsigned int maior_nota=0;
        MOVS     R5,#+0
//  514   eTECLA tecla;
//  515   
//  516   PARAMETROS_le(ADR_NOTAS,(void*)&flag_notas);
        ADD      R1,SP,#+0
        MOVS     R0,#+2
          CFI FunCall PARAMETROS_le
        BL       PARAMETROS_le
//  517   if(flag_notas&0x01)
        LDRB     R0,[SP, #+0]
        LSLS     R0,R0,#+31
        BPL.N    ??APLICACAO_verifica_disponibilidade_troco_0
//  518     maior_nota = 100;
        MOVS     R5,#+100
//  519   if(flag_notas&0x02)
...
//  526     maior_nota = 2000;
        MOV      R5,#+2000
//  527   /*
//  528   if(flag_notas&0x20)
//  529     maior_nota = 5000;
//  530   */
//  531   
//  532   if( APLICACACAO_verifica_troco()<maior_nota){
...
//  533     
//  534     BOARD_setter_led_instrucao(LED_FORA_SERVICO,PISCANDO);
        MOVS     R1,#+2
        MOVS     R0,#+6
          CFI FunCall BOARD_setter_led_instrucao
        BL       BOARD_setter_led_instrucao
//  535     PAGAMENTOS_set_bloqueio(1);
        MOVS     R0,#+1
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  536     STRING_write_to_external(CLEAR_DISPLAY,
//  537                              (char*)STRING_mensagem_sem_troco[idioma][0],
//  538                              (char*)STRING_mensagem_sem_troco[idioma][1]);    
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
...
//  539     
//  540     for(;APLICACACAO_verifica_troco()<maior_nota;){
//  541         
//  542       tecla = TECLADO_getch();
//  543       switch(tecla){
//  544         case TECLA_ENTER:
//  545             APLIACAO_wait_lcd();
//  546             BOARD_liga_placa_instrucao(0);
//  547             MCFG_entry();                     
//  548             BOARD_liga_placa_instrucao(1);
//  549             idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
//  550             APLICACAO_release_lcd();             
//  551             STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);        
//  552             break;
//  553         case TECLA_ESC:
//  554             break;
//  555       }    
//  556       
//  557       APLICACAO_tela_descanso();      
...
//  558     }//Fim do for(;;)        
//  559     PAGAMENTOS_set_bloqueio(0);
??APLICACAO_verifica_disponibilidade_troco_9:
        MOVS     R0,#+0
          CFI FunCall PAGAMENTOS_set_bloqueio
        BL       PAGAMENTOS_set_bloqueio
//  560     BOARD_liga_placa_instrucao(0);
        MOVS     R0,#+0
          CFI FunCall BOARD_liga_placa_instrucao
        BL       BOARD_liga_placa_instrucao
//  561     BOARD_liga_placa_instrucao(1);
        MOVS     R0,#+1
          CFI FunCall BOARD_liga_placa_instrucao
        BL       BOARD_liga_placa_instrucao
//  562     BOARD_setter_led_instrucao(LED_INSIRA_DINHEIRO,PISCANDO);
        MOVS     R1,#+2
        MOVS     R0,#+2
          CFI FunCall BOARD_setter_led_instrucao
        BL       BOARD_setter_led_instrucao
...
//  565 /***********************************************************************************
//  566 *       Descrição       :       Verifica o barramento MDB
//  567 *       Parametros      :       nenhum
//  568 *       Retorno         :       nenhum
//  569 ***********************************************************************************/
        ...
        THUMB
//  570 void APLICACAO_verifica_MDB(void){
APLICACAO_verifica_MDB:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  571   eIDIOMA idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
          CFI FunCall APLICACAO_carrega_idioma
        BL       APLICACAO_carrega_idioma
        MOVS     R4,R0
//  572   
//  573   switch(MDB_checa_dispositivos()){
...
//  574     case MDB_TODOS_ONLINE:            
//  575          return;
??APLICACAO_verifica_MDB_0:
??APLICACAO_verifica_MDB_4:
        POP      {R4,PC}          ;; return
//  576     case MDB_BILL_OFFLINE:
//  577          STRING_write_to_external(CLEAR_DISPLAY,
//  578                                   (char*)STRING_mensagem_noteiro_mdb_offline[idioma][0],
//  579                                   (char*)STRING_mensagem_noteiro_mdb_offline[idioma][1]);          
...
//  580          break;
        B.N      ??APLICACAO_verifica_MDB_3
//  581     case MDB_COIN_OFFLINE:
//  582          STRING_write_to_external(CLEAR_DISPLAY,
//  583                                   (char*)STRING_mensagem_moedeiro_mdb_offline[idioma][0],
//  584                                   (char*)STRING_mensagem_moedeiro_mdb_offline[idioma][1]);           
...
//  590   for(;;){
//  591     
//  592     if(MDB_checa_dispositivos()==MDB_TODOS_ONLINE)
//  593       return;
//  594     
//  595     tecla = TECLADO_getch();
//  596     switch(tecla){
//  597       case TECLA_ENTER:
//  598             APLIACAO_wait_lcd();
//  599             BOARD_liga_placa_instrucao(0);
//  600             MCFG_entry();                     
//  601             BOARD_liga_placa_instrucao(1);
//  602             idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
//  603             APLICACAO_release_lcd();             
//  604             STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);              
//  605            break;
//  606       case TECLA_ESC:
//  607            break;
//  608     }    
//  609     APLICACAO_tela_descanso();      
...
//  612 }
//  613 /***********************************************************************************
//  614 *       Descrição       :       Faz a verificação do meio de pagamento
//  615 *                               CCTALK
//  616 *       Parametros      :       nenhum
//  617 *       Retorno         :       nenhum
//  618 ***********************************************************************************/
        ...
        THUMB
//  619 void APLICACAO_verifica_cctalk(void){
APLICACAO_verifica_cctalk:
        ...
        SUB      SP,SP,#+8
          CFI CFA R13+16
//  620   unsigned char flag;
//  621   
//  622   PARAMETROS_le(ADR_FLAG_BV20,(void*)&flag);
        ADD      R1,SP,#+0
        MOVS     R0,#+1
          CFI FunCall PARAMETROS_le
        BL       PARAMETROS_le
...
//  626   
//  627   eIDIOMA idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
??APLICACAO_verifica_cctalk_0:
          CFI FunCall APLICACAO_carrega_idioma
        BL       APLICACAO_carrega_idioma
        MOVS     R4,R0
//  628   eBV20_state estado_atual = BV20_get_current_state();
          CFI FunCall BV20_get_current_state
        BL       BV20_get_current_state
//  629   
//  630   if(estado_atual!=BV20_OFFLINE)
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        CMP      R0,#+3
        BNE.N    ??APLICACAO_verifica_cctalk_1
//  631     return;
//  632   
//  633   STRING_write_to_external(CLEAR_DISPLAY,
//  634                            (char*)STRING_mensagem_cctalk_offline[idioma][0],
//  635                            (char*)STRING_mensagem_cctalk_offline[idioma][1]);       
...
//  639   for(;;){
//  640     
//  641     estado_atual = BV20_get_current_state();
//  642     
//  643     if(estado_atual!=BV20_OFFLINE)
//  644       return;
//  645     
//  646     tecla = TECLADO_getch();
//  647     switch(tecla){
//  648       case TECLA_ENTER:
//  649             BOARD_reset_tempo_propaganda();
//  650             APLIACAO_wait_lcd();
//  651             BOARD_liga_placa_instrucao(0);
//  652             MCFG_entry();                     
//  653             BOARD_liga_placa_instrucao(1);
//  654             idioma  = (eIDIOMA)APLICACAO_carrega_idioma();
//  655             APLICACAO_release_lcd();             
//  656             STRING_write_to_internal(CLEAR_DISPLAY,NULL,NULL);              
//  657             BOARD_reset_tempo_propaganda();
//  658            break;
//  659       case TECLA_ESC:
//  660            break;
//  661     }    
//  662     APLICACAO_tela_descanso();      
...
//  665 }
//  666 /***********************************************************************************
//  667 *       Descrição       :       Faz a verificação cíclica dos sinais 
//  668 *                               do papel e do termistor
...
//  671 ***********************************************************************************/
        ...
        THUMB
//  672 void APLICACAO_verificao_ciclica(void){
APLICACAO_verificao_ciclica:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  673   
//  674   switch(POST_verificacao_ciclica()){
...
//  675    case POST_CICLICO_SUCESSO:
//  676         break;
??APLICACAO_verificao_ciclica_0:
        B.N      ??APLICACAO_verificao_ciclica_3
//  677    case POST_CICLICO_FALHA_EMBALAGEM:
//  678         STRING_write_to_external(CLEAR_DISPLAY,"E03:FALTA","EMBALAGEM");
??APLICACAO_verificao_ciclica_2:
        ...
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_external
        BL       STRING_write_to_external
//  679         APLICACAO_loop_falha_ciclica();
          CFI FunCall APLICACAO_loop_falha_ciclica
        BL       APLICACAO_loop_falha_ciclica
//  680         break;
        B.N      ??APLICACAO_verificao_ciclica_3
//  681    case POST_CICLICO_FALHA_TERMISTOR:
//  682         STRING_write_to_external(CLEAR_DISPLAY,"E04:FALHA","SENS. TEMP.");
...
//  687 /***********************************************************************************
//  688 *       Descrição       :       Menu do loop onde há a falha no sensor de
//  689 *                               temperatura ou falta de embalagem
//  690 *       Parametros      :       nenhum
//  691 *       Retorno         :       nenhum
//  692 ***********************************************************************************/
        ...
        THUMB
//  693 void APLICACAO_loop_falha_ciclica(void){
APLICACAO_loop_falha_ciclica:
        PUSH     {R4,LR}
          ...
          CFI CFA R13+8
//  694   eTECLA tecla;
//  695   unsigned char loop=1;
        MOVS     R4,#+1
        B.N      ??APLICACAO_loop_falha_ciclica_0
//  696     
//  697   for(;loop;){
//  698     
//  699     tecla = TECLADO_getch();
//  700     switch(tecla){
//  701       case TECLA_ENTER:
//  702           MCFG_entry();                     
//  703            break;
//  704       case TECLA_ESC:
//  705            loop = 0;
...
//  710   }  
//  711   
//  712   STRING_write_to_internal(CLEAR_DISPLAY,"REINICIANDO","VERIFICACAO");
...
//  715 /***********************************************************************************
//  716 *       Descrição       :       Ciclo de desumidificação da máquina
//  717 *       Parametros      :       nenhum
//  718 *       Retorno         :       nenhum
//  719 ***********************************************************************************/
        ...
        THUMB
//  720 void APLICACAO_ciclo_desumidificador(unsigned char flag){
APLICACAO_ciclo_desumidificador:
        PUSH     {R4,LR}
          ...
          CFI CFA R13+8
//  721   
//  722   if(flag && !APLICACAO_tempo_desumidificador){
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        CMP      R0,#+0
...
//  723     
//  724     unsigned int tempo=30000;
        MOVW     R4,#+30000
//  725     
//  726     STRING_write_to_internal(CLEAR_DISPLAY,"CICLO DE","DESUMIDIFICACAO");
        LDR.N    R2,??DataTable14_29
        LDR.N    R1,??DataTable14_30
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_internal
        BL       STRING_write_to_internal
//  727     STRING_write_to_external(CLEAR_DISPLAY,"CICLO DE","DESUMIDIFICACAO");
        LDR.N    R2,??DataTable14_29
        LDR.N    R1,??DataTable14_30
        MOVS     R0,#+0
          CFI FunCall STRING_write_to_external
...
//  734     while(tempo--){
//  735       
//  736       if(POTENCIA_getRPMmedido()<1000){
//  737         CT_set_temperatura(0);
//  738         POTENCIA_setRPM(0);
//  739         POTENCIA_set_neutro(0);        
//  740         return;
//  741       }
//  742       vTaskDelay(1);
...
//  743     }
//  744     
//  745     CT_set_temperatura(0);
??APLICACAO_ciclo_desumidificador_3:
        MOVS     R0,#+0
          CFI FunCall CT_set_temperatura
        BL       CT_set_temperatura
//  746     POTENCIA_setRPM(0);
        MOVS     R0,#+0
          CFI FunCall POTENCIA_setRPM
        BL       POTENCIA_setRPM
//  747     POTENCIA_set_neutro(0);
        MOVS     R0,#+0
          CFI FunCall POTENCIA_set_neutro
        BL       POTENCIA_set_neutro
//  748     APLICACAO_verifica_post();
          CFI FunCall APLICACAO_verifica_post
        BL       APLICACAO_verifica_post
//  749     APLICACAO_tempo_desumidificador = TEMPO_DESUMIDIFICADOR;
        LDR.N    R0,??DataTable14_28
        LDR.N    R1,??DataTable14_31  ;; 0x1b7740
        STR      R1,[R0, #+0]
//  750   }
//  751 }
