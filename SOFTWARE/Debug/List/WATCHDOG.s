///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.50.3.4676/W32 for ARM     24/Jul/2017  15:06:38 /
...
//   85   WDCLKSEL_bit.WDSEL =   0x00; // Oscilador RC
        LDR.N    R0,??WATCHDOG_init_0  ;; 0x40000010
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+2
        LSLS     R0,R0,#+2
...
//   87   
//   88   WDTC = 2048*2000;
        LDR.N    R0,??WATCHDOG_init_0+0x4  ;; 0x40000004
        MOVS     R1,#+4096000
        STR      R1,[R0, #+0]
//   89   FEEDS_THE_DOG();    
        LDR.N    R0,??WATCHDOG_init_0+0x8  ;; 0x40000008
        MOVS     R1,#+170
        STR      R1,[R0, #+0]
        LDR.N    R0,??WATCHDOG_init_0+0x8  ;; 0x40000008
        MOVS     R1,#+85
